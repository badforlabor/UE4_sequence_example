...
#include "SwingElevatorTrack.generated.h"

/**
 * 
 */
UCLASS()
class SEQEX_API USwingElevatorTrack : public UMovieSceneTrack
{
	GENERATED_BODY()

public:
	USwingElevatorTrack(const FObjectInitializer& InInitializer)
		: Super(InInitializer)
	{
